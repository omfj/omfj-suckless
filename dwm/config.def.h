...
static const char *colors[][3]           = {
	...
	[SchemeSel]  = { col_gray3, col_fore,  col_bord  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_fore, "-sf", col_gray3, NULL };
...
static Key keys[] = {
	...
	{ ShiftMask,                    XF86XK_AudioLowerVolume,  spawn,          {.v = voldownsmall } },
	{ ShiftMask,                    XF86XK_AudioRaiseVolume,  spawn,          {.v = volupsmall } },
